  ...
  return (
    <section id="features" className="section-shell scroll-mt-28 pb-20 md:scroll-mt-32">
      <SectionIntro
        ...
        description="Core system benefits designed to improve sorting accuracy and operational visibility."
      />
      <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {featureCards.map((card, index) => (
          ...
          >
            ...
            <p className="mt-4 text-sm leading-7 text-[#27292b]">{card.description}</p>
          </motion.article>
        ))}
      </div>
    </section>
